...
exports.User = typebox_1.Type.Object(Object.assign(Object.assign({}, base_model_1.BaseModelSchema), { platformRole: typebox_1.Type.Enum(PlatformRole), status: typebox_1.Type.Enum(UserStatus), identityId: typebox_1.Type.String(), externalId: (0, base_model_1.Nullable)(typebox_1.Type.String()), platformId: (0, base_model_1.Nullable)(typebox_1.Type.String()), lastChangelogDismissed: (0, base_model_1.Nullable)(typebox_1.Type.String()) }));
exports.UserWithMetaInformation = typebox_1.Type.Object({
    ...
    lastChangelogDismissed: (0, base_model_1.Nullable)(typebox_1.Type.String()),
