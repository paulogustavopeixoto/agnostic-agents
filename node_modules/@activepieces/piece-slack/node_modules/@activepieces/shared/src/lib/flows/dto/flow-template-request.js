...
exports.FlowTemplate = typebox_1.Type.Object(Object.assign(Object.assign({}, common_1.BaseModelSchema), { name: typebox_1.Type.String(), description: typebox_1.Type.String(), type: typebox_1.Type.Enum(TemplateType), tags: typebox_1.Type.Array(typebox_1.Type.String()), pieces: typebox_1.Type.Array(typebox_1.Type.String()), schemaVersion: (0, common_1.Nullable)(typebox_1.Type.String()), blogUrl: typebox_1.Type.Optional(typebox_1.Type.String()), template: exports.FlowVersionTemplate, projectId: typebox_1.Type.Optional(typebox_1.Type.String()), platformId: typebox_1.Type.String(), metadata: (0, common_1.Nullable)(metadata_1.Metadata) }));
