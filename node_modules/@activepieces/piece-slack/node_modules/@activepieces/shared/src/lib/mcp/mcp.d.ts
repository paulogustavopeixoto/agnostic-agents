...
import { McpToolType } from './tools/mcp-tool';
...
export declare const McpWithTools: import("@sinclair/typebox").TObject<{
    id: import("@sinclair/typebox").TString;
    name: import("@sinclair/typebox").TString;
    created: import("@sinclair/typebox").TString;
    updated: import("@sinclair/typebox").TString;
...
export declare const McpToolMetadata: import("@sinclair/typebox").TObject<{
    displayName: import("@sinclair/typebox").TString;
...
export declare const mcpToolNaming: {
    fixTool: (name: string, id: string, type: McpToolType) => string;
    fixProperty: (schemaName: string) => string;
    extractToolId: (toolName: string) => string;
};
