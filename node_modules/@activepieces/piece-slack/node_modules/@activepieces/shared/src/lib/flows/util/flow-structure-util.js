...
const extractConnectionIdsFromAuth = (auth) => {
    var _a, _b;
    return (_b = (_a = auth.match(/{{connections\['([^']*(?:'\s*,\s*'[^']*)*)'\]}}/)) === null || _a === void 0 ? void 0 : _a[1].split(/'\s*,\s*'/).map(id => id.trim())) !== null && _b !== void 0 ? _b : [];
};
const extractConnectionIds = (flowVersion) => {
    var _a, _b;
