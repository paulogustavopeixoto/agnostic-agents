...
exports.SUPPORTED_AI_PROVIDERS = void 0;
...
const replicate = (0, replicate_1.createReplicate)({
...
`,
        ...
        languageModels: [
            {
                displayName: 'GPT-4o',
                instance: (0, openai_1.openai)('gpt-4o'),
            ...
            },
            {
                ...
                instance: (0, openai_1.openai)('gpt-4o-mini'),
                functionCalling: true,
                pricing: {
                    input: 0.40,
                    output: 1.60,
            ...
            },
            {
                ...
                instance: (0, openai_1.openai)('gpt-4-turbo'),
                functionCalling: true,
                pricing: {
                    input: 10.00,
                    output: 30.00,
            ...
            },
            {
                ...
                instance: (0, openai_1.openai)('gpt-3.5-turbo'),
            ...
            {
                displayName: 'GPT-4.1',
                instance: (0, openai_1.openai)('gpt-4.1'),
                functionCalling: true,
                pricing: {
                    input: 2.00,
                    output: 8.00,
            ...
            },
            {
                ...
                instance: (0, openai_1.openai)('gpt-4.1-mini'),
                functionCalling: true,
                pricing: {
                    input: 0.40,
                    output: 1.60,
            ...
            },
            {
                ...
                instance: (0, openai_1.openai)('gpt-4.1-nano'),
                functionCalling: true,
                pricing: {
                    input: 0.10,
                    output: 0.40,
            ...
            {
                displayName: 'O3 Mini',
                instance: (0, openai_1.openai)('o3-mini'),
                functionCalling: true,
                pricing: {
                    input: 1.10,
                    output: 4.40,
            ...
            {
                displayName: 'O4 Mini',
                instance: (0, openai_1.openai)('o4-mini'),
                functionCalling: true,
                pricing: {
                    input: 1.10,
                    output: 4.40,
        ...
        imageModels: [
            {
                ...
                instance: openai_1.openai.image('dall-e-3'),
                pricing: {
                    standard: {
                        '1024x1024': 0.04,
                        '1024x1792': 0.08,
            ...
            },
            {
                ...
                instance: openai_1.openai.image('dall-e-2'),
                pricing: {
                    standard: {
                        '256x256': 0.016,
                        '512x512': 0.018,
        ...
        languageModels: [
            {
                ...
                instance: (0, anthropic_1.anthropic)('claude-3-5-sonnet-latest'),
                functionCalling: true,
                pricing: {
                    input: 3.00,
                    output: 15.00,
            ...
            },
            {
                ...
                instance: (0, anthropic_1.anthropic)('claude-3-5-haiku-20241022'),
                functionCalling: true,
                pricing: {
                    input: 0.80,
                    output: 4.00,
            ...
            },
            {
                ...
                instance: (0, anthropic_1.anthropic)('claude-3-opus-20240229'),
                functionCalling: true,
                pricing: {
                    input: 15.00,
                    output: 75.00,
            ...
            },
            {
                ...
                instance: (0, anthropic_1.anthropic)('claude-3-sonnet-20240229'),
                functionCalling: true,
                pricing: {
                    input: 3.00,
                    output: 15.00,
            ...
            },
            {
                ...
                instance: (0, anthropic_1.anthropic)('claude-3-haiku-20240307'),
                functionCalling: true,
                pricing: {
                    input: 0.25,
                    output: 1.25,
            ...
            },
            {
                ...
                instance: (0, anthropic_1.anthropic)('claude-3-7-sonnet-latest'),
                functionCalling: true,
                pricing: {
                    input: 3.00,
                    output: 15.00,
        ...
        languageModels: [
            {
                ...
                instance: (0, google_1.google)('gemini-2.5-pro'),
                functionCalling: true,
                pricing: {
                    input: {
                        threshold: 200000,
            ...
            },
            {
                ...
                instance: (0, google_1.google)('gemini-2.5-flash'),
                functionCalling: true,
                pricing: {
                    input: {
                        default: 0.30,
            ...
            },
            {
                ...
                instance: (0, google_1.google)('gemini-2.5-flash-lite-preview-06-17'),
                functionCalling: true,
                pricing: {
                    input: {
                        default: 0.10,
            ...
            },
            {
                ...
                instance: (0, google_1.google)('gemini-2.0-flash-lite'),
                functionCalling: true,
                pricing: {
                    input: 0.075,
                    output: 0.30,
...
//# sourceMappingURL=supported-ai-providers.js.map