...
export declare const FlowRunResponse: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TObject<{
    ...
    steps: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TRecord<import("@sinclair/typebox").TString, import("@sinclair/typebox").TUnknown>>;
...
export declare const isFlowUserTerminalState: (status: FlowRunStatus) => boolean;
