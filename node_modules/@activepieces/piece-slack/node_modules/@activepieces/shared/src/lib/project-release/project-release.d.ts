...
export declare const ProjectRelease: import("@sinclair/typebox").TObject<{
    ...
    importedBy: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnsafe<string | null>>;
    ...
    importedByUser: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TObject<{
        ...
        lastChangelogDismissed: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TUnsafe<string | null>>;
