...
export type EngineOperation = ExecuteStepOperation | ExecuteToolOperation | ExecuteFlowOperation | ExecutePropsOptions | ExecuteTriggerOperation<TriggerHookType> | ExecuteExtractPieceMetadata | ExecuteValidateAuthOperation;
...
export declare const EngineResult: import("@sinclair/typebox").TObject<{
    result: import("@sinclair/typebox").TUnknown;
}>;
export declare const EngineError: import("@sinclair/typebox").TObject<{
    error: import("@sinclair/typebox").TUnknown;
}>;
