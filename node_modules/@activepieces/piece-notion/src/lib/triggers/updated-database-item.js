...
exports.updatedDatabaseItem = void 0;
...
exports.updatedDatabaseItem = (0, pieces_framework_1.createTrigger)({
    auth: __1.notionAuth,
...
const polling = {
    ...
    items: (_a) => tslib_1.__awaiter(void 0, [_a], void 0, function* ({ auth, propsValue, lastItemId }) {
        ...
        if (lastItem) {
            ...
            lastUpdatedDate = (0, dayjs_1.default)(lastUpdatedEpochMS).toISOString();
        }
        else {
            lastUpdatedDate = lastItem;
        }
        const items = yield getResponse(auth, propsValue.database_id, lastUpdatedDate);
        return items.map((item) => {
            const object = item;
            return {
                id: object.id + '|' + (0, dayjs_1.default)(object.last_edited_time).valueOf(),
                data: item,
            };
        });
    }),
...
//# sourceMappingURL=updated-database-item.js.map