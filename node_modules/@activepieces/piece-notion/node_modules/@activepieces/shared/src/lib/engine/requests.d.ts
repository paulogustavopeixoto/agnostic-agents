...
export declare const UpdateRunProgressResponse: import("@sinclair/typebox").TObject<{
...
export declare const NotifyFrontendRequest: import("@sinclair/typebox").TObject<{
    runId: import("@sinclair/typebox").TString;
}>;
