...
exports.User = typebox_1.Type.Object(Object.assign(Object.assign({}, base_model_1.BaseModelSchema), { email: typebox_1.Type.String(), firstName: typebox_1.Type.String(), lastName: typebox_1.Type.String(), trackEvents: typebox_1.Type.Boolean(), newsLetter: typebox_1.Type.Boolean(), password: typebox_1.Type.String(), verified: typebox_1.Type.Boolean(), platformRole: typebox_1.Type.Enum(PlatformRole), status: typebox_1.Type.Enum(UserStatus), externalId: typebox_1.Type.Optional(typebox_1.Type.String()), platformId: (0, base_model_1.Nullable)(typebox_1.Type.String()), tokenVersion: typebox_1.Type.Optional(typebox_1.Type.String()) }));
