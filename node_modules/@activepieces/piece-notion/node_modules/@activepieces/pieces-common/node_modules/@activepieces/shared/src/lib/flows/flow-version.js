...
exports.FlowVersionMetadata = exports.FlowVersion = exports.FlowVersionState = exports.LATEST_SCHEMA_VERSION = void 0;
...
exports.FlowVersion = typebox_1.Type.Object(Object.assign(Object.assign({}, base_model_1.BaseModelSchema), { flowId: typebox_1.Type.String(), displayName: typebox_1.Type.String(), trigger: trigger_1.Trigger, updatedBy: (0, base_model_1.Nullable)(typebox_1.Type.String()), valid: typebox_1.Type.Boolean(), schemaVersion: (0, base_model_1.Nullable)(typebox_1.Type.String()), state: typebox_1.Type.Enum(FlowVersionState) }));
exports.FlowVersionMetadata = typebox_1.Type.Object(Object.assign(Object.assign({}, base_model_1.BaseModelSchema), { flowId: typebox_1.Type.String(), displayName: typebox_1.Type.String(), valid: typebox_1.Type.Boolean(), state: typebox_1.Type.Enum(FlowVersionState), updatedBy: (0, base_model_1.Nullable)(typebox_1.Type.String()), schemaVersion: (0, base_model_1.Nullable)(typebox_1.Type.String()), updatedByUser: (0, base_model_1.Nullable)(user_1.UserMeta) }));
